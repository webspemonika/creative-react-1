    ...
    return (
        <section className='h-screen bg-no-repeat bg-center bg-cover flex justify-center ' style={{ backgroundImage: `url(${heroImg})` }}>
            ...
            <div className="mt-[120px] lg:mt-[160px] z-10">
                <h1 className="text-center text-white  text-3xl lg:text-6xl  font-medium font-['Poppins'] capitalize leading-9 lg:leading-[83.20px]">Make your interior more<br />minimalistic & modern</h1>
                <p className="text-center text-white  text-md lg:text-2xl font-extralight font-['Poppins']  leading-6 lg:leading-10 mt-6 lg:mt-[50px]">
